...
{
	float x, y;
	Vector2() : x(0.0f), y(0.0f) {} //default constructor because otherwise all Vector3s needed to follow below constructor format
	Vector2(float x, float y) : x(x), y(y) {} //constructor for functions that return a Vector3 construction
